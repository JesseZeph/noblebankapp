...
import 'package:mybankapp/homescreen/withdrawmonydetailsscreens/withdrawdetailsscreen.dart';
import 'package:mybankapp/images/images.dart';
import 'package:mybankapp/textfontfamily/textfontfamily.dart';

class WithdrawMoneyBottomSheetWidget extends StatefulWidget {
  const WithdrawMoneyBottomSheetWidget({Key? key}) : super(key: key);

  @override
  _WithdrawMoneyBottomSheetWidgetState createState() =>
      _WithdrawMoneyBottomSheetWidgetState();
}

class _WithdrawMoneyBottomSheetWidgetState
    extends State<WithdrawMoneyBottomSheetWidget> {
  String number = "";
